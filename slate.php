...
if ( ! class_exists( 'SVG_Logo_and_Text_Effects' ) ) {
	...
	final class SVG_Logo_and_Text_Effects {
		...
		public static function action_activation() {
			update_option( self::OPT_PLUGIN_VERSION, '1.3.0' );
...
HTML;
			...
			$html .= '<li><b>' . __( 'Visual Composer version', 'slate'  ) . ':</b> ' .
		...
		public function action_plugin_action_links( $links ) {
			$links[] = '<a href="' . admin_url( 'options-general.php?page=slate_settings_page' ) . '">'
				. __( 'Settings', 'slate' ) . '</a>';
			$links[] = '<a href="http://www.dashed-slug.net/svg-logo-and-text-effects-wordpress-plugin" style="color: #dd9933;">dashed-slug.net</a>';
			return $links;
		}
